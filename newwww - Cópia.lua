...
function MacLib:Window(Settings)
	...
	function WindowFunctions:TabGroup()
      ...
      full.Size = UDim2.new(1, -10, 0, 0)
      full.Position = UDim2.new(0, 5, 0, 0)
      
      local fullLayout = Instance.new("UIListLayout")
      fullLayout.Padding = UDim.new(0, 10)
      fullLayout.FillDirection = Enum.FillDirection.Vertical
      fullLayout.HorizontalAlignment = Enum.HorizontalAlignment.Left
      fullLayout.SortOrder = Enum.SortOrder.LayoutOrder
      fullLayout.Parent = full
      
      full.Parent = elementsScrolling
        ...
        if Settings.Full then
            section.Parent = full
            section.SectionFrame.Size = UDim2.new(1, -10, 0, section.SectionFrame.Size.Y.Offset)
        else
